...
Для настройки и хранения слоев в дереве объектов предназначена системная папка **Картографические слои**. Данная папка содержит вложенную системную папку **Геоподосновы**, которая предназначена для настройки и хранения [геоподоснов](#подключение-удаленного-растрового-слоя). Содержимое папки **Геоподосновы** отображается в [меню управления геоподосновами] <a href="#меню_управления_геоподосновами">Меню управления геоподосновами</a> на карте.
