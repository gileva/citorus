...
2.  Укажите, в какое свойство типа следует поместить геоданные из файла. Для этого добавьте в таблицу новую строку нажатием на кнопку ![](https://github.com/gileva/citorus/blob/master/12.png?raw=true), которая расположена над таблицей, и щелкните по данной строке мышью, чтобы активировать свойства файла и типа. Затем в свойствах типа выберите свойство **object > geo > geoJSON**, а в свойствах файла – свойство **geometry**.

![](https://github.com/gileva/citorus/blob/master/ris16_2.png?raw=true "Рисунок 18 – Геоданные")
...
![](https://github.com/gileva/citorus/blob/master/ris24.png?raw=true "Рисунок 27 – Инструменты работы с картой")
...
![](https://github.com/gileva/citorus/blob/master/ris31.png?raw=true "Рисунок 34 – Меню инструментов")
...
![](https://github.com/gileva/citorus/blob/master/ris33.png?raw=true "Рисунок 36 – Полигон")
